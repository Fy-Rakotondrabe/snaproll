...
class AppL10n {
  ...
  String get generateSubtitle => _t(
    'Appuie sur la roue pour découvrir ton défi',
    'Press the wheel to discover your challenge',
  );
  String get generateSpinning => _t('La roue tourne...', 'Spinning...');
  String get generateSpinAgain => _t(
    'Appuie à nouveau pour un nouveau défi',
  ...
  String get colorChasingTip1 => _t(
    'Cherche des scènes où une couleur domine',
    'Scout scenes where one color dominates',
  );
  String get colorChasingTip2 => _t(
    'Laisse la couleur guider ta composition. Place ton sujet pour créer un contraste ou une harmonie.',
    'Let the color guide your composition. Position your subject for contrast or harmony.',
  );
  String get colorChasingTip3 => _t(
    'Variations bienvenues: différentes nuances et saturations de la même couleur créent de la profondeur.',
    'Variations welcome: different shades and saturations of the same hue add depth.',
  );

  // Progress page
  String get progressTitle => _t('Progression', 'Progress');
  String get progressSubtitle =>
      _t('Ton parcours photographique', 'Your photography journey');
  String get progressStreakLabel => _t('Série quotidienne', 'Daily streak');
  String get progressStreakUnit => _t('jours', 'days');
  String get progressStreakMotivation =>
      _t('Continue comme ça !', 'Keep it up!');
  ...
  String get learnNoResultsHint =>
      _t('Essaie un autre mot-clé', 'Try another keyword');
  ...
  String get settingsNotifBody => _t(
    'Lance la roue et relève ton défi photo !',
    'Spin the wheel and take on your photo challenge!',
  );
}
...
class _AppL10nDelegate extends LocalizationsDelegate<AppL10n> {
  ...
  @override
  bool isSupported(Locale locale) => AppL10n.supportedLocales.any(
